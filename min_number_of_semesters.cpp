...
int main(int argc, char **argv)
{
	...
	// Get the list of courses which don't require any prerequisites.
	for(cnt = 0; cnt < num_of_courses; cnt++)
	{
		// Update semester and add this course to list of removed courses.
	...
	// Update semester details of all courses which require prerequisite courses.
	while(1)
	{
		sem_cnt++;
		...
		// Check if all courses have their semester value updated.
